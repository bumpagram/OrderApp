...
1) надо вынести в MenuTableViewConroller код по конфигу ячейки в отдельную функцию. так было вначале, но я забил на это. теперь кода еще больше, придется. 
2) и в Order TVC тоже потом.
